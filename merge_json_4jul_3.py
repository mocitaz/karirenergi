...
json_4jul_3_dir = os.path.join(base_dir, "JSON_4Jul(3)")
...
# Scan for all JSON files in JSON_4Jul(3)
new_json_files = glob.glob(os.path.join(json_4jul_3_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} JSON files in JSON_4Jul(3) to process.")
