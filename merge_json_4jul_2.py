...
json_4jul_2_dir = os.path.join(base_dir, "JSON_4JUL(2)")
...
# Scan for all JSON files in JSON_4JUL(2)
new_json_files = glob.glob(os.path.join(json_4jul_2_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} JSON files in JSON_4JUL(2) to process.")
