...
json_4jul_dir = os.path.join(base_dir, "JSON_4Jul")
...
# Scan for all JSON files in JSON_4Jul
new_json_files = glob.glob(os.path.join(json_4jul_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} new JSON files in JSON_4Jul/ to merge.")
...
print(f"Successfully merged data from JSON_4Jul!")
