...
json_baruni_dir = os.path.join(base_dir, "jsonbarunih")
...
# Scan for all JSON files in jsonbarunih
new_json_files = glob.glob(os.path.join(json_baruni_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} JSON files in jsonbarunih to process.")
