...
json_baru_dir = os.path.join(base_dir, "BARU")
...
# Scan for all JSON files in BARU
new_json_files = glob.glob(os.path.join(json_baru_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} JSON files in BARU to process.")
