...
json_tes_dir = os.path.join(base_dir, "TES")
...
# Scan for all JSON files in TES
new_json_files = glob.glob(os.path.join(json_tes_dir, "loker_data*.json"))
print(f"Found {len(new_json_files)} JSON files in TES to process.")
