...
export default function App() {
  ...
  const filteredListings = useMemo(() => {
    let result = listings.filter((job) => {
      ...
      return matchSearch && matchCompany && matchMajor && matchCity && matchEdu && matchSector;
    });
    ...
    return result;
  }, [listings, search, selectedCompany, selectedMajor, selectedCity, selectedEdu, selectedSector, sortBy]);
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <nav className="flex flex-col gap-1">
              <button
                className={`flex items-center w-full px-2.5 py-2 rounded-md text-[13px] hover:bg-[#edece9] text-[#37352f] font-medium bg-[#edece9]/50 ${sidebarOpen ? "justify-start" : "justify-center"
                  }`}
                title="Semua Lowongan"
              >
                <Briefcase className="w-4 h-4 text-[#5a5a57] flex-shrink-0" />
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center justify-between">
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded w-fit ${tagColor.bg} ${tagColor.text}`}>
                            {job["Perusahaan"]}
                          </span>
                        ...
                        {/* Location */}
                        <div className="flex items-center gap-1.5 text-[11.5px] text-[#5a5a57]">
...
function EmptyState() {
  return (
    <div className="col-span-full py-16 flex flex-col items-center justify-center text-center text-[#9b9a97] gap-3">
      ...
      <div className="text-[14px] font-medium">Tidak ada lowongan ditemukan</div>
      <div className="text-[12px]">Coba ubah kriteria filter pencarian Anda.</div>
    </div>
  );
}
